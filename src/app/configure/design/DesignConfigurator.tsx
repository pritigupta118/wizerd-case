...
import { COLORS, FINISHES, MATERIALS, MODELS } from "@/validator/option-validator"
import { Label } from "@/components/ui/label"
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger, DropdownMenuItem } from "@/components/ui/dropdown-menu"
import { Button } from "@/components/ui/button"
import { ArrowBigRight, Check, ChevronsUpDown } from "lucide-react"
...
const DesignConfigurator = ({ configId, imgUrl, imgDimensions }: DesignConfigProps) => {
  ...
  const [renderedPositions, setRenderedPosition] = useState({
    x: 150,
    y: 205
  })
  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        title: "Something went wrong",
        description: "There is a problem saving your config, please try again",
        variant: 'destructive'
      })
    }
  }
    ...
    <div className='relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
      <div
        ...
        <div className='relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]'>
          <AspectRatio
            ref={phoneCaseRef}
            ratio={896 / 1831} className="pointer-events-none relative z-50 aspect-[896/1831]">
            <NextImage fill alt="phone image" src="/phone-template.png" className="pointer-events-none z-50 select-none" />
          </AspectRatio>
          <div className="absolute z-40 inset-0 left-[3px] top-px right-[3px] bottom-px shadow-[0_0_0_99999px_rgba(229,231,235,0.6)] rounded-[32px]" />
        ...
        >
          <div className="relative w-full h-full">
            <NextImage src={imgUrl} fill alt="your img" className="pointer-events-none" />
          </div>
        </Rnd>
      </div>
