      ...
      <section>
        ...
        <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
          <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
            <div className="absolute w-56 left-0 -top-20 hidden lg:block">
            <div className='absolute inset-x-0 bottom-0 bg-gradient-to-t via-slate-50/50 from-slate-50 h-28' />
              <img src="/harry-2.png" className="w-full"/>
            </div>
            <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">Your image on a {''}
              <span className="bg-orange-600 px-2 text-white">Custom</span>{' '} Phone case</h1>
            <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
              Capture your favourite memories with your own, {' '} <span className="font-semibold">one-of-one</span> phone case.
              WizardCobra allows you to protect your memories, not just your phone case.
            </p>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <Phone className="w-64" imgSrc="/testimonials/ex-2.jpg"/>
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">What our{' '} <span className="relative px-2">customers{' '}
              ...
              <img src="/harry-1.png" className="w-36 order-0 lg:order-2" alt="" />
          </div>
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
            <div className='relative flex flex-col items-center md:grid grid-cols-2 gap-40'>
              ...
              <Phone className='w-60' imgSrc='/full-2.jpg' />
            </div>
          </div>
